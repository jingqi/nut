...
template <typename T> uint32_t _AES<T>::KT0[256];
template <typename T> uint32_t _AES<T>::KT1[256];
template <typename T> uint32_t _AES<T>::KT2[256];
template <typename T> uint32_t _AES<T>::KT3[256];
...
template<typename T> uint32_t _AES<T>::RT1[256];
template<typename T> uint32_t _AES<T>::RT2[256];
template<typename T> uint32_t _AES<T>::RT3[256];

template<typename T> uint32_t _AES<T>::RCON[10];
...
template <typename T> uint32_t _AES<T>::FT0[256] = { FT };
#undef V

#define V(a,b,c,d) 0x##d##a##b##c
template <typename T> uint32_t _AES<T>::FT1[256] = { FT };
#undef V

#define V(a,b,c,d) 0x##c##d##a##b
template <typename T> uint32_t _AES<T>::FT2[256] = { FT };
#undef V

#define V(a,b,c,d) 0x##b##c##d##a
template <typename T> uint32_t _AES<T>::FT3[256] = { FT };
#undef V
...
#define V(a,b,c,d) 0x##a##b##c##d
template <typename T> uint32_t _AES<T>::RT0[256] = { RT };
#undef V

#define V(a,b,c,d) 0x##d##a##b##c
template <typename T> uint32_t _AES<T>::RT1[256] = { RT };
#undef V

#define V(a,b,c,d) 0x##c##d##a##b
template <typename T> uint32_t _AES<T>::RT2[256] = { RT };
#undef V

#define V(a,b,c,d) 0x##b##c##d##a
template <typename T> uint32_t _AES<T>::RT3[256] = { RT };
#undef V
