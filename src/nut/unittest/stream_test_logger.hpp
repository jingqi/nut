...
public:
    ...
    virtual void finish()
    {
        m_ostream << std::endl <<
            ...
            "> failed fixtures : " << m_count_of_failed_fixtures << (0 == m_count_of_failed_fixtures ? "  √" : "  ×") << std::endl <<
            "> total cases  : " << m_count_of_cases << std::endl <<
            "> failed cases : " << m_count_of_failed_cases << (0 == m_count_of_failed_cases ? "  √" : "  ×") << std::endl;
