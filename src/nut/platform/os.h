...
public:
    ...
    static void list_dir(const wchar_t *path, std::vector<std::wstring> *appended, bool exclude_file = false,
            bool exclude_dir = false, bool exclude_initial_dot = false);
    static void list_dir(const std::string& path, std::vector<std::string> *appended, bool exclude_file = false,
            bool exclude_dir = false, bool exclude_initial_dot = false);
    static void list_dir(const std::wstring& path, std::vector<std::wstring> *appended, bool exclude_file = false,
            bool exclude_dir = false, bool exclude_initial_dot = false);
