...
public:
    ...
    //     bool exclude_dir = false, bool exclude_initial_dot = false); // Implicit conversion
     ...
     * 复制文件
     */
    // static bool copyfile(const char *src, const char *dst); // Implicit conversion
    // static bool copyfile(const wchar_t *src, const wchar_t *dst); // Implicit conversion
     ...
     * 删除文件
     */
    // static bool removefile(const char *path); // Implicit conversion
    // static bool removefile(const wchar_t *path); // Implicit conversion
     ...
     * 创建目录
     */
    // static bool mkdir(const char *path); // Implicit conversion
    // static bool mkdir(const wchar_t *path); // Implicit conversion
     ...
     * 创建目录树
     */
    // static bool mkdirs(const char *path); // Implicit conversion
     ...
     * 删除空目录
     */
    // static bool rmdir(const char *path); // Implicit conversion
    // static bool rmdir(const wchar_t *path); // Implicit conversion
     ...
     * 删除目录树
     */
    // static bool rmtree(const char *path); // Implicit conversion
    // static bool rmtree(const wchar_t *path); // Implicit conversion
     ...
     * 读取符号链接地址
     */
    // static std::string readlink(const char *path); // Implicit conversion
    // static std::wstring readlink(const wchar_t *path); // Implicit conversion
     ...
     */
    // static bool symlink(const char *link, const char *path); // Implicit conversion
    // static bool symlink(const wchar_t *link, const wchar_t *path); // Implicit conversion
     ...
     * 重命名/移动
     */
    // static bool rename(const char *from, const char *to); // Implicit conversion
    // static bool rename(const wchar_t *from, const wchar_t *to); // Implicit conversion
